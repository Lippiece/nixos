{
  ...
  home.file = {
    ".config/BraveSoftware/Brave-Browser/NativeMessagingHosts/".source = "${pkgs.plasma-browser-integration}/etc/chromium/native-messaging-hosts/org.kde.plasma.browser_integration.json";
